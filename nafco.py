...
st.set_page_config(page_title='売り上げ分析（ナフコ）')
st.markdown('#### 売り上げ分析（ナフコ）')
...
original_list = ['O.K.ﾓｶ', 'OAK KNOT（ｵｰｸﾅｯﾄ）', 'PS店ｵﾘｼﾞﾅﾙ', 'SOLIDTIME(ｿﾘｯﾄﾞﾀｲﾑ)']
...
def original_ratio():
    ...
    with col1:
        ...
        st.caption('O.K.ﾓｶ/OAK KNOT（ｵｰｸﾅｯﾄ/PS店ｵﾘｼﾞﾅﾙ/SOLIDTIME(ｿﾘｯﾄﾞﾀｲﾑ)')
